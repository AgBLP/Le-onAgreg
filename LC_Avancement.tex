...
\begin{tabularx}{\paperwidth-2cm}{| X | X | c | X |}
  ...
  \hline
  \textbf{Synthèse, traitement, caractérisations} & Filtration sous vide & \textcolor{red}{\textbf{0\%}}  & 1ère générale - spécialité \\
  \hline
  \hline
...
\begin{tabularx}{\paperwidth-2cm}{| X | X | c | X |}
  ...
  \hline
  \textbf{Diagrammes E-pH} & Mettre en \oe uvre une médiamutation & \textcolor{red}{0\%} & MPSI \\
  \hline
